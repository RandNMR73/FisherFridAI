...
from specificity import get_specificity_score
...
# from langchain_test import retrieved_response
# specific_goals.append("something else about")
# chat_history = []
# nonSpecific = specific_goals[-1]
# response, chat_history = retrieved_response(nonSpecific, chat_history)